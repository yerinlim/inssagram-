...
#header .row>.col-4 img {
   ...
   <div id="wrapper">
				...
				<div class="col-8">
					...
					<ul class="actions">
						...
						<li class="following_list"><p><a href="#following_list">
									팔로잉 <strong>${fn:length(following_list)}</strong>
								</a></p></li>
					</ul>
					<ul class="actions">
		...
		<nav id="nav2" class="">
         <ul>
            <li><a href="${pageContext.request.contextPath}/myTimeLine">타임라인</a></li>
            <li><a href="${pageContext.request.contextPath}/myGallery" class="active">갤러리</a></li>
         </ul>
      </nav>
						...
						<c:forEach var="r" items="${list}">
							<div class="col-4">
								<span class="image fit">
									<a href="#myModal">
										<img class="myImg" src="${pageContext.request.contextPath}/resources/images/${r.picture}" alt="텍스트 예제 1">
									</a>
								</span>
							</div>
						</c:forEach>
					...
					<div class="modal-dialog">
						...
						<div class="row" style="padding: 10px; margin: 1em;">
							...
							<div class="col-5">
								...
								<div class="alt">
									<h5>
										<strong>${user.id_}</strong> 노을이 너무 아름답다
									</h5>
								</div>
					...
					<div class="modal-dialog">
						<div class="row-inline">
							<h5 class="center" style=" height: 25px; line-height: 25px; margin-top:0.5em; font-weight: bold;">
								팔로워 
								<span class="close right">&times;&ensp;</span>
							</h5>
						</div>
		...
		$(document).ready(function() {
			...
			$('.submit_on_enter').keydown(function(event) {
	         ...
	         $(".userGallery").on("click", function(){
	        	 var id_ = $(this).text();
	        	 var myId = "{userSession.id_}";
	        	 if(id_==myId){
		        	window.location.assign("${pageContext.request.contextPath}/myGallery?id_="+id_);
	        	 }else{
